    ...
    if masks is not None:
        ...
        if class_names[int(box.cls)] == "track-line":
            if len(box.data)>1:
                    ...
                    print("track-line1: ", xmin, ymin, xmax, ymax)
                    ...
                    print("track-line2: ", xmin1, ymin1, xmax1, ymax1)
                ...
                print("track-line3: ", xmin, ymin, xmax, ymax)
                
        if class_names[int(box.cls)] == "road":
            r_xmin = int(box.data[0][0])
            r_ymin = int(box.data[0][1])
            r_xmax = int(box.data[0][2])
            r_ymax = int(box.data[0][3])
            
            print("track-line3: ", r_xmin, r_ymin, r_xmax, r_ymax)
